...
def test_module_registers_handlers_with_slack_app():
    import services.fraud_detection.src.controllers.handlers.slack.promotion as module
    assert module is not None

def test_handler_module_imports_slack_app():
    from services.fraud_detection.src.controllers.handlers.slack.promotion import slack_app
