...
from services.fraud_api.src.modules.schemas import DeployedModel
...
class MlflowModel:
    def __init__(self, model_uri: str, class_name: str):
        ...
        logger.info(f"{class_name} loaded: {self.model_uri} → version {self.deployed_model.model_version}")
