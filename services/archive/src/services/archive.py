...
from services.shared.src.repositories.s3.bucket import ensure_bucket
    ...
    while True:
        with sql_session.begin() as session:
            ...
            for item in transaction_inferences:
                transaction_inferences_by_date[item[TransactionInferences.transaction_timestamp.key].date()].append(item)
