...
from dags.modules.schemas.airflow.drift_monitor import CreateTrainPendingWorkflowXCom, CheckCurrentModelDeploymentWorkflowXCom, UpdateTrainingPendingWorkflowXCom
from dags.modules.schemas.model_deployment_workflow import ModelDeploymentWorkflow, ModelDeploymentWorkflowState
from dags.repositories.mlflow.registered_model import replace_challenger_model
...
def update_training_pending_workflow(**context) -> None:
    update_training_pending_workflow_xcom = UpdateTrainingPendingWorkflowXCom.from_context(context)
