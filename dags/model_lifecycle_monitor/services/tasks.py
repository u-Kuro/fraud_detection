...
from dags.shared.modules.configs.airflow import DagIDs, DriftMonitorKeys
from dags.shared.modules.schemas.airflow import AirflowTaskContext
from dags.shared.services.airflow_operators import no_action

trigger_challenger_model_rotation_task_id = "trigger_challenger_model_rotation"
trigger_challenger_model_rotation = TriggerDagRunOperator(
    task_id=trigger_challenger_model_rotation_task_id,
    trigger_dag_id=DagIDs.CHALLENGER_MODEL_ROTATION,
