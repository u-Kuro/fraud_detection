...
from dags.challenger_model_rotation.modules.schemas.airflow.xcom import ReplaceExpiredModelXCom, DeleteExpiredModelXCom
...
def replace_expired_model(**context) -> None:
    ...
    mlflow_client.set_registered_model_alias(
        ...
        alias=mlflow_config.CHALLENGER_ALIAS,
