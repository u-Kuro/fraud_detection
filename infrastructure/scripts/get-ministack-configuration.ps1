...
$ministack_container_json_config = (docker inspect $ministack_container_name | ConvertFrom-Json)[0]
$ministack_container_environments = ($ministack_container_json_config.Config.Env -join "`n") | ConvertFrom-StringData
$ministack_container_network_settings = $ministack_container_json_config.NetworkSettings
...
$ministack_network_gateway = $ministack_container_networks_config.$ministack_network.Gateway
...
$ministack_container_ip = $ministack_container_networks_config.$ministack_network.IPAddress
