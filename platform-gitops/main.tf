...
module "postgresql" {
  ...
  mle_postgresql_username = var.mle_postgresql_username
  mle_postgresql_password = var.mle_postgresql_password

  mle_migrations_postgresql_username  = var.mle_migrations_postgresql_username
  mle_migrations_postgresql_password  = var.mle_migrations_postgresql_password
